...
public class DateUtil {
    ...
    /**
     * 格式化时间从yyyy-MM-dd HH:mm到Wed Mar 02 09:19:00 CST 2016
     * @param args
     * @throws ParseException 
     */
    ...
    /**
     * 格式化时间从yyyy-MM-dd HH到Wed Mar 02 09:19:00 CST 2016
     * @param args
     * @throws ParseException 
     */
    ...
    /**
     * 格式化时间从yyyy-MM-dd到Wed Mar 02 09:19:00 CST 2016
     * @param args
     * @throws ParseException 
     */
    ...
    /**
     * 格式化时间从MM-dd,HH:mm到Wed Mar 02 09:19:00 CST 2016
     * @param args
     * @throws ParseException 
     */
    ...
    /**
     * 格式化时间从自定义 到Wed Mar 02 09:19:00 CST 2016
     * @param args
     * @throws ParseException 
     */
    public static Date parseSelfDate(String date,String format) throws ParseException {  
    	SimpleDateFormat sdf = new SimpleDateFormat(format);
    	Date da = sdf.parse(date);
    	return da;  
    }  
    ...
    public static void main(String[] args) throws ParseException {  
      ...
      //  HttpSession session = request.getSession();
       ...
       // System.out.println(session); 
        ...
        System.out.println(parseSelfDate("1988-11-11 11:11", "yyyy-MM-dd HH:mm").toLocaleString());
    }  
}
