# 数据库 
#创建数据库
DROP DATABASE IF EXISTS yayaopromotion_db;
CREATE DATABASE yayaopromotion_db;

#使用数据库 
use yayaopromotion_db;
#创建管理表 
...
INSERT INTO manager_tb (manager_phone,manager_password) values ('15111336587','123456');
